...
with st.sidebar:
    ...
    # VARNOSTNA NADGRADNJA: Ključ se ne shranjuje v serverske secrets
...
st.divider()
st.caption("SIS Universal Knowledge Synthesizer | v12.1 Organic Interdisciplinary Integration | 2026")
